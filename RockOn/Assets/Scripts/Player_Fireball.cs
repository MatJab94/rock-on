...
public class Player_Fireball : MonoBehaviour
{
    ...
    private Vector3 _target; // target's position
    ...
    void Start()
    {
        ...
        Transform Cursor = GameObject.FindGameObjectWithTag("Cursor").GetComponent<Transform>();
        _target = new Vector3(Cursor.position.x, Cursor.position.y, Cursor.position.z);
    ...
    {
        Vector3 vectorToTarget = _target - _fireball.position;
